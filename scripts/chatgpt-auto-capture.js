...
(function() {
    ...
    // Download conversation in selected format (fire and forget)
        ...
        try {
            ...
            switch(selectedFormat) {
                ...
                case 'txt':
                    ...
                    content += `Messages: ${conversation.length}\n\n`;
                    content += '='.repeat(50) + '\n\n';
                ...
                default:
                    ...
                    conversation.forEach(msg => {
                        ...
                        content += `## ${roleEmoji} ${msg.role === 'user' ? 'User' : 'ChatGPT'}\n\n`;
                        content += msg.content + '\n\n';
            ...
            link.href = url_blob;
            link.download = `${sanitizedTitle}_${timestamp}.${extension}`;
